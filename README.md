...
> **I'm Hema Sumarthi**, an Artificial Intelligence and Data Science
> student passionate about programming, data analytics and problem solving.

</div>

I enjoy turning ideas into practical projects and continuously exploring
new technologies. I'm currently strengthening my skills in **Java, Python,
SQL and Data Analytics** while developing real-world projects.
...
| ✦ Conflict Resolution | ✦ Negotiation | ✦ Teamwork |
|:---:|:---:|:---:|
| Handling challenges constructively | Finding effective solutions | Collaborating with others |
...
Data Structures project developed using **Java** and tree concepts to represent and manage family relationships.
...
Java-based authentication project using **OOP concepts** with biometric data handling and database integration.
...
### Radar-Based Human Detection

Disaster-response system designed to detect living persons under rubble using **radar and sensor technology**.
...
`Data Science` • `Artificial Intelligence` • `Java` • `Python` • `SQL` • `Problem Solving`
...
<a href="mailto:hemasumarthi2006@gmail.com">
<img src="https://img.shields.io/badge/📧%20Email-7C3AED?style=for-the-badge">
</a>
